...
# Function to get the weather from mongodb fastapi endpoint
...
# Function to get the accidents from mongodb fastapi endpoint
...
def get_city_weather_api(): 
    try:
        airports_ourairports= get_airports_mongo_db() # Using "airports_lufthansa" collection from mongodb to get cities 
